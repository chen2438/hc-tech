export const site = {
  name: 'HC Digital Services',
  businessName: 'HC Digital Services',
  title: 'Independent Software & AI Services',
  description:
    'Independent software and AI developer building custom software, AI systems, intelligent agents and business automation.',
  siteUrl: 'https://hc-digital.vayki.com',
  email: 'hc_digital@vayki.com',
